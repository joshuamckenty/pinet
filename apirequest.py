...
class APIRequest(object):
    ...
    def send(self, user, **kwargs):
        ...
        self.context = APIRequestContext(user, request_id)
        ...
        d = defer.maybeDeferred(method, self.context, **kwargs)
    ...
    def _render_response(self, response_data):
        ...
        request_id_el.appendChild(xml.createTextNode(self.context.request_id))
